"""
Django settings for SintoniaMental project.
...
MIDDLEWARE = [
    ...
    'SintoniaMental.middleware.AuthenticationMiddleware',
    # adicinado 
    #'django.middleware.security.SecurityMiddleware',
...
ROOT_URLCONF = 'SintoniaMental.urls'
...
WSGI_APPLICATION = 'SintoniaMental.wsgi.application'
